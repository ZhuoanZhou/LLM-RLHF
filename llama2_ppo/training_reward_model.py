# command to run:
# accelerate launch --config_file deepspeed_zero3.yaml --multi_gpu --num_machines 1 --num_processes 4 training_reward_model.py --model_name="meta-llama/Llama-2-7b-hf" --output_dir="models/training_reward_model/" --gradient_checkpointing=false --max_length=768 --dataset_name 'reward_data/PPO_option1_option2.json'
