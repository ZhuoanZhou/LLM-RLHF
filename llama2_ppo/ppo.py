...
#       accelerate launch --config_file deepspeed_zero3.yaml --multi_gpu --num_machines 1 --num_processes 4 ppo.py
...
def setup_args(script_args:ScriptArguments):
    script_args.model_name = "results/llama2_sft_7b_chat/final_checkpoint" 
    script_args.tokenizer_name = "meta-llama/Llama-2-7b-chat-hf"
    script_args.reward_model_name = "models/training_reward_model/peft_last_checkpoint"
    ...
    script_args.max_length = 768 # maximum length of the input
    script_args.output_max_length = 384 # maximum length of the output
    script_args.mini_batch_size = 1 # batch size. 1 because of limited resources.
    ...
    script_args.output_dir = "models/tuning_llama_rl"
