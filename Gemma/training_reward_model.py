# command to run:
# accelerate launch --config_file /home/jovyan/shared/projects/cakeai-trl/examples/accelerate_configs/deepspeed_zero3.yaml --multi_gpu --num_machines 1 --num_processes 4 training_reward_model.py --model_name="google/gemma-2b-it" --output_dir="models/training_reward_model/" --gradient_checkpointing=false --max_length=1024 --dataset_name '../reward_data/ppo_reward_model_data.json'

# Old command: (dataset was too simple.)
# accelerate launch --config_file /home/jovyan/shared/projects/cakeai-trl/examples/accelerate_configs/deepspeed_zero3.yaml --multi_gpu --num_machines 1 --num_processes 4 training_reward_model.py --model_name="google/gemma-2b-it" --output_dir="models/training_reward_model/" --gradient_checkpointing=false --max_length=1024 --dataset_name '../reward_data/PPO_option1_option2.json'
...
class ScriptArguments:
    ...
    local_rank: Optional[int] = field(default=4, metadata={"help": "Used for multi-gpu"})
    ...
    eval_freq: Optional[int] = field(default=50)
    save_freq: Optional[int] = field(default=50)
...
class RewardDataCollatorWithPadding:
    ...
    padding: Union[bool, str, PaddingStrategy] = True # (True)
