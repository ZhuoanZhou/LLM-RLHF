...
output_dir = "results/option_1_repsonse_added_early_stop/final_merged_checkpoint"
tokenizer_dir = "results/option_1_repsonse_added_early_stop/final_merged_checkpoint"
...
df['option_1_output'] = results
df.to_csv("data/test_finetuned_option_1.csv",index=False)
