...
output_dir = "results/option_3/final_merged_checkpoint"
tokenizer_dir = "results/option_3/final_merged_checkpoint"
...
df['option_3_output'] = results
df.to_csv("data/test_finetuned_option_3_output.csv",index=False)
