...
# load un-augmented data and split dataset into train and val
#data_files = {"train": "train_set.csv"}
#dataset = load_dataset("Misaka19487/Indeed_llama2", data_files=data_files, use_auth_token=True, split='train')
...
soft_skill_list = {0:"None",
                   ...
                   6:"Proactive and take initiative", 
...
def create_prompt_formats(sample):
    ...
    instruction = "Follow the steps to answer the question. First, enumerate the ranges with a precision of one decimal place. Next, check if the target number is in the enumerated range. Finally, determine which range the target number belongs.\n\n"

    sample["text"] = instruction + sample['CoT_demo_prompt'] + "\n" + sample['response']
    return sample
...
print("val set size:", len(eval_dataset))
...
output_dir = "results/option_3/final_checkpoint"
...
if lora_flag:
    ...
    output_merged_dir = "results/option_3/final_merged_checkpoint"
